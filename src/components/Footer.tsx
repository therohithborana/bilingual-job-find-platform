        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/quick-jobs" className="text-gray-300 hover:text-white">Quick Jobs</Link>
              </li>
              <li>
                <Link to="/worker/profile" className="text-gray-300 hover:text-white">Create Profile</Link>
              </li>
              <li>
                <Link to="#" className="text-gray-300 hover:text-white">Skill Development</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/recruiter/job-post" className="text-gray-300 hover:text-white">Post a Job</Link>
              </li>
              <li>
                <Link to="#" className="text-gray-300 hover:text-white">Find Workers</Link>
              </li>
              <li>
                <Link to="/recruiter/company-register" className="text-gray-300 hover:text-white">Register Company</Link>
              </li>
              <li>
